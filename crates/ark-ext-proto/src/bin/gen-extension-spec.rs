...
fn method_table() -> Vec<MethodEntry> {
    vec![
        ...
        MethodEntry {
            method: "pane/emit",
            section: "Pane/Stack handle ops",
            request: PaneEmitRequest::SHAPE,
            response: PaneEmitResponse::SHAPE,
            kind: Kind::Request,
        },
        MethodEntry {
            method: "pane/replace_view",
            section: "Pane/Stack handle ops",
            request: PaneReplaceViewRequest::SHAPE,
            response: PaneReplaceViewResponse::SHAPE,
            kind: Kind::Request,
        },
        MethodEntry {
            method: "pane/close",
            section: "Pane/Stack handle ops",
            request: PaneCloseRequest::SHAPE,
            response: PaneCloseResponse::SHAPE,
            kind: Kind::Request,
        },
        MethodEntry {
            method: "stack/spawn_pane",
            section: "Pane/Stack handle ops",
            request: StackSpawnPaneRequest::SHAPE,
            response: StackSpawnPaneResponse::SHAPE,
            kind: Kind::Request,
        },
        MethodEntry {
            method: "stack/close_child",
            section: "Pane/Stack handle ops",
            request: StackCloseChildRequest::SHAPE,
            response: StackCloseChildResponse::SHAPE,
            kind: Kind::Request,
        },
        MethodEntry {
            method: "stack/clear",
            section: "Pane/Stack handle ops",
            request: StackClearRequest::SHAPE,
        ...
        MethodEntry {
            ...
            section: "Feature-group hooks",
            request: SceneCompileHookRequest::SHAPE,
            response: SceneCompileHookResponse::SHAPE,
            kind: Kind::Request,
        },
        MethodEntry {
            method: "control_verbs",
            section: "Feature-group hooks",
            request: ControlVerbsRequest::SHAPE,
            response: ControlVerbsResponse::SHAPE,
            kind: Kind::Request,
        },
        MethodEntry {
            method: "doctor_checks",
            section: "Feature-group hooks",
            request: DoctorChecksRequest::SHAPE,
            response: DoctorChecksResponse::SHAPE,
            kind: Kind::Request,
        },
        MethodEntry {
            method: "list_columns",
            section: "Feature-group hooks",
            request: ListColumnsRequest::SHAPE,
            response: ListColumnsResponse::SHAPE,
            kind: Kind::Request,
        },
        // -- Workspace ---------------------------------------------------
        MethodEntry {
